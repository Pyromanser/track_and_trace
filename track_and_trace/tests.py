...
class ShipmentTestCase(APITestCase):
    def setUp(self):
        ...
        self.detail_url = reverse(
            "track_and_trace:shipment-detail", kwargs={"pk": self.shipment_1.pk}
        )
    ...
    def test_list_shipments(self, mock_get):
        mock_get.side_effect = [
            type(
                ...
                {
                    "status_code": 200,
                    "json": lambda: {"lat": "40.7128", "lon": "-74.0060"},
                },
            ),
            type(
                "Response",
                (object,),
                {"status_code": 200, "json": lambda: {"weather": "rain"}},
            ),
            type(
                "Response",
                (object,),
                {
                    "status_code": 200,
                    "json": lambda: {"lat": "20.6355", "lon": "27.1401"},
                },
            ),
            type(
                "Response",
                (object,),
                {"status_code": 200, "json": lambda: {"weather": "sunny"}},
            ),
        ]
